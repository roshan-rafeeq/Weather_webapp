    ...
    <>
      <div className=" w-full h-full ">
        <div className="text-center p-2 py-4 px-6 relative">
          ...
          />
          <div
            className="absolute inset-y-0 left-[71%] right-[20%] pl-10
                    flex items-center 
                    pointer-events-none"
          >
            <svg
            ...
            >
              <path
                ...
                d="M11 4a7 7 0 017 7 7 7 0 01-1.49 4.39l4.32 4.32a1 1 0 01-1.41 1.41l-4.32-4.32A7 7 0 1111 4zm0 2a5 5 0 100 10 5 5 0 000-10z"
              />
            </svg>
          </div>
        </div>
        {data && data.main ? (  
          ...
          <b className="text-white text-2xl text-center">Search for weather info⛅</b>
          </div>
        )}
      </div>
    </>
